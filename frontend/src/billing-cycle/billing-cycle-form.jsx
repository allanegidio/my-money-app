...
import { init, initWithoutList } from './billing-cycle-actions.js'
...
class BillingCycleForm extends Component {
	...
	calculateSummary() {
		...
		return {
			...
			sumOfDebits: this.props.debits.map(debit => +debit.value || 0).reduce(sum, 0)
		}
	}
...
const mapDispatchToProps = dispatch => bindActionCreators({ init, initWithoutList }, dispatch)
